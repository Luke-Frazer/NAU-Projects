...
def decryptor(message):
    ...
    if key == key:
        ...
        while messlen > 1:
            ...
            if {a, b} <= row1 or {a, b} <= row2 or {a, b} <= row3 \
                or {a, b} <= row4 or {a, b} <= row5:
                if a in row1:
                    ...
                    answer = (matrix[newa])
                    answer = answer + (matrix[newb])
            elif {a, b} <= col1 or {a, b} <= col2 or {a, b} <= col3 \
                or {a, b} <= col4 or {a, b} <= col5:
                if a in col1:
...
def encryptor(message):
    ...
    while messlen > 1:
        ...
        if a == b:
            b = sub
        if {a, b} <= row1 or {a, b} <= row2 or {a, b} <= row3 or {
                a, b
        } <= row4 or {a, b} <= row5:
            if a in row1:
                rowloca = lrow1.index(a)
        ...
        elif {a, b} <= col1 or {a, b} <= col2 or {a, b} <= col3 or {
                a, b
        } <= col4 or {a, b} <= col5:
            if a in col1:
                colloca = lcol1.index(a)
